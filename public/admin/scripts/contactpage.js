                          ...
                          {/* table header */}
                            ...
                            <td>
                              ...
                              >
                                ...
                                <option value="mHaircut">Men's Haircut</option>
                                {/* option for womens haircut */}
                                <option value="wHaircut">Women's Haircut</option>
                                {/* option for all over color */}
                                <option value="allColor">All Over Color</option>
                          ...
                          {/* table header */}
                            ...
                            <td>
                              ...
                              >
                                ...
                                {/* jamie */}
                                <option value="jcole">Jamie Cole</option>
                                {/* me */}
                                <option value="bwilliams">Braylyn Williams</option>
                                {/* henry */}
                                <option value="hcampbell">Henry Campbell</option>
                                {/* penelope */}
                                <option value="pasher">Penelope Asher</option>
                              </select>
                            </td>
                        </tr>
                    </tbody>
